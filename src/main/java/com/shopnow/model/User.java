...
public class User  implements Serializable
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5313532186143202724L;
	...
	public User(int id, String email, String userName, Long phoneNumber, String password, String rolename) {
		super();
		this.id = id;
		this.email = email;
		this.userName = userName;
